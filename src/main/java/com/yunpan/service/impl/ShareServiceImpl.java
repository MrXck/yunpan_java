...
public class ShareServiceImpl extends ServiceImpl<ShareMapper, Share> implements ShareService {
    ...
    @Override
    public Map<Object, Object> share(Map<String, Object> map, HttpSession session, HttpServletRequest request) {
    ...
    @Override
    public Object getShare(Integer share_id, HttpServletRequest request, HttpSession session) {
    ...
    @Override
    public Object getShare(Integer share_id, Map<String, String> map, HttpServletRequest request, HttpSession session) {
        Share share = shareMapper.selectById(share_id);
    ...
    @Override
    public Object shareFiles(Integer share_id, HttpSession session) {
        Integer share_id1 = (Integer) session.getAttribute("share_id");
        if(share_id1 == null || !share_id1.equals(share_id)){
    ...
    @Override
    public Object shareFiles(Integer share_id, Map<String, Integer> map, HttpSession session) {
    ...
    @Override
    public Object getShareFiles(Map<String, Object> map, HttpSession session) {
        Map<Object, Object> result = new HashMap<>();
        Integer user_id = (Integer) session.getAttribute("user_id");
        try {
